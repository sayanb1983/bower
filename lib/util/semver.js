...
function maxSatisfying(versions, range, strictMatch) {
    console.log("Why is maxSatisfying called?");
...
function getSatisfyingVersion(versions, range, isMin) {
    if (isMin) {
        var minVer = semver.minSatisfying(versions, range);
        console.log("Min version is " + minVer);
        return minVer;
    } else {
...
function maxSatisfyingIndex(versions, range, strictMatch) {
    console.log("Why is maxSatisfyingIndex called?");
